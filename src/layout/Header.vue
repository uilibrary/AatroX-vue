...
const sideBarToggle = () => {
    ...
    let secondarySideNav = store.state.largeSidebar.sidebarToggleProperties.isSecondarySideNavOpen
    ...
    <div class="header-wrapper flex bg-white justify-between px-4 ">
        <div class="flex items-center">
            ...
            <div class="mx-0 sm:mx-3">
                <button @click="sideBarToggle" class=" menu-toggle cursor-pointer text-gray-500 align-middle focus:outline-none " type="button">
           ...
           <!-- mega-menu  -->
            ...
            <Menu as="div" class="relative inline-block text-left">
                <div>
                    <MenuButton class="btn-sm mx-3 md:block hidden focus:outline-none dropdown-button">
                        <div class="flex items-center">
                    ...
                    <div class="">
                        <MenuItem>
                            <div class="grid grid-cols-12 gap-5">
                                <div class="col-span-4 bg-gradient-to-r from-purple-500 to-purple-700">
                                    <div class="p-4">
                                        ...
                                        <BaseBtn class="border border-yellow-500 text-yellow-500 hover:bg-yellow-500 hover:text-white" rounded>Learn More</BaseBtn>
                                    </div>
                                </div>
                                <div class="col-span-4">
                                    <div class="p-4">
                                        <p class="text-purple-500 border-b border-purple-500 inline-block mb-4">Features</p>
                                        <div class="menu-icon-grid flex justify-between flex-wrap">
                                            <a class="hover:bg-purple-500 hover:text-white text-gray-600 p-5 inline-flex flex-col items-center rounded w-24" href="#">
                                ...
                                <div class="col-span-4">
                                    <div class="p-4">
                                        <p class="text-purple-500 border-b border-purple-500 inline-block mb-4">Components</p>
                                        <ul class="links">
                                            <li> <a class="hover:text-purple-500 text-gray-600" href="#">Accordion </a></li>
                                            <li> <a class="hover:text-purple-500 text-gray-600" href="#">Alerts </a></li>
                                            <li> <a class="hover:text-purple-500 text-gray-600" href="#">Buttons </a></li>
                                            <li> <a class="hover:text-purple-500 text-gray-600" href="#">Badges </a></li>
                                            <li> <a class="hover:text-purple-500 text-gray-600" href="#">Carousels </a></li>
                                            <li> <a class="hover:text-purple-500 text-gray-600" href="#">Lists </a></li>
                                            <li> <a class="hover:text-purple-500 text-gray-600" href="#">Popover </a></li>
                                            <li> <a class="hover:text-purple-500 text-gray-600" href="#">Tables </a></li>
                                            <li> <a class="hover:text-purple-500 text-gray-600" href="#">Datatables </a></li>
                                            <li> <a class="hover:text-purple-500 text-gray-600" href="#">Modals </a></li>
                                            <li> <a class="hover:text-purple-500 text-gray-600" href="#">Sliders </a></li>
                                            <li> <a class="hover:text-purple-500 text-gray-600" href="#">Tabs </a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="flex items-center">
            ...
            <button class="hidden mr-0 btn btn-sm hover:bg-gray-100 sm:block rounded p-1 md:mr-2">
                <i class="i-Full-Screen text-gray-800 text-xl"></i>
            </button> 
            

            <Menu as="div" class="relative inline-block text-left">
                <div>
                    <MenuButton class="btn btn-sm hover:bg-gray-100 rounded  w-full px-4 py-2 text-sm font-medium">
                    ...
                    <div class="">
                        <MenuItem>
                            <div class="flex justify-between flex-wrap">
                                <a class="hover:bg-purple-500 hover:text-white text-gray-600 p-4 inline-flex flex-col items-center rounded w-20" href="#">
                                    <i class="i-Shop-4 text-2xl"> </i>Home
                                </a>
                                <a class="hover:bg-purple-500 hover:text-white text-gray-600 p-4 inline-flex flex-col items-center rounded w-20" href="#">
                                    <i class="i-Library text-2xl"></i>UI Kits
                        ...
                        >
                            ...
                            >
                                <div  class="flex flex-1 justify-between">
                                    <div>
                                        <h6>New Message</h6>
                                        <p :class="[ active ? 'text-gray-300': 'text-gray-500']">How are you ?</p>
                                    </div>
                                    <div>
                                         <p :class="[active ? 'text-gray-200': 'text-gray-400']">10s</p>
                                    </div>
                                </div>
