...
[![materio-logo](https://aatrox-demo.vercel.app/assets/images/logo.png)](https://themeselection.com/products/materio-free-vuetify-vuejs-admin-template) 

# [Materio - Vuetify VueJS Free Admin Template](https://themeselection.com/products/materio-free-vuetify-vuejs-admin-template)

Production ready carefully crafted most comprehensive admin template

[![license](https://img.shields.io/github/license/themeselection/materio-vuetify-vuejs-admin-template-free) ](https://github.com/themeselection/materio-vuetify-vuejs-admin-template-free/blob/main/LICENSE) ![GitHub Workflow Status](https://img.shields.io/github/workflow/status/themeselection/materio-vuetify-vuejs-admin-template-free/Deploy) [ ![GitHub release](https://img.shields.io/github/release/themeselection/materio-vuetify-vuejs-admin-template-free.svg) ](https://github.com/themeselection/materio-vuetify-vuejs-admin-template-free/releases) [![Twitter Follow](https://img.shields.io/twitter/follow/Theme_Selection)](https://twitter.com/Theme_Selection)
